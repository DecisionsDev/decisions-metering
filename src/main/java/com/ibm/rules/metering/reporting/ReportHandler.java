...
import com.ibm.rules.metering.registration.repository.RegistrationRepository;
import com.ibm.rules.metering.registration.repository.RegistrationService;
import com.ibm.rules.metering.reporting.repository.ReportEntity;
import com.ibm.rules.metering.reporting.repository.ReportRepository;
import com.ibm.rules.metering.reporting.repository.ReportStatus;
...
public class ReportHandler {
	...
	@Scheduled(fixedRateString="${com.ibm.rules.metering.processingRate}", initialDelayString = "${com.ibm.rules.metering.processingInitialDelay}")
