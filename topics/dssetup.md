...
The res-setup task is described at [res-setup](https://www.ibm.com/support/knowledgecenter/SSQP76_8.10.x/com.ibm.odm.dserver.rules.ref.res/ant_tasks/con_ant_res_setup.html). To setup metering, use the following guide.
